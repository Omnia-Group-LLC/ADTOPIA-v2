-- Apply admin_activity_log migration directly
-- This can be run via Supabase Dashboard SQL Editor or CLI
...
-- Enable realtime for activity_log (if extension exists)
DO $$
BEGIN
